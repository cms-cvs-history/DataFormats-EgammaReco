...
reco::ClusterShape::ClusterShape( double cEE, double cEP, double cPP, 
                  ...
                  std::vector<double> pseudoZernikeMoments,
  ...
  e2x5Bottom_(e2x5Bottom), e3x2Ratio_(e3x2Ratio), eMaxId_(eMaxId), e2ndId_(e2ndId),
  pseudoZernikeMoments_(pseudoZernikeMoments),
  energyBasketFractionEta_(energyBasketFractionEta),energyBasketFractionPhi_(energyBasketFractionPhi)
{
}
